...
function gettingData() {
    ...
    if (redPlaying) {
        playerNamesDiv.innerHTML += `<div id="redPlayerName"><b>Red Player:</b> ${redPlayerName}</div>`;
    }
    if (greenPlaying) {
        playerNamesDiv.innerHTML += `<div id="greenPlayerName"><b>Green Player:</b> ${greenPlayerName}</div>`;
    }
    if (bluePlaying) {
        playerNamesDiv.innerHTML += `<div id="bluePlayerName"><b>Blue Player:</b> ${bluePlayerName}</div>`;
    }
    if (yellowPlaying) {
        playerNamesDiv.innerHTML += `<div id="yellowPlayerName"><b>Yellow Player:</b> ${yellowPlayerName}</div>`;
    }
